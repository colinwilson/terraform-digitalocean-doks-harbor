resource "helm_release" "harbor" {
  ...
  values = [fileexists("${path.root}/${var.values_file}") == true ? file("${path.root}/${var.values_file}") : templatefile("${path.module}/harbor_chart_values/${var.harbor_expose_type}.yaml.tftpl", {
